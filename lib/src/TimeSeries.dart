...
class TimeSeries extends BaseAPI {
  ...
  Future<JSONObject> getMonthlyAdjusted(String symbol,
      {String? outputsize}) async {
    return this.getRequest(
        function: _monthlyAdjusted, symbol: symbol, outputsize: outputsize);
  }

  Future<JSONObject> getBatchStockQuotes(String symbols,
      {String? outputsize}) async {
    return this.getRequest(
        function: _batchStockQuotes, symbols: symbols, outputsize: outputsize);
  }
}
