...
class AlphaVantageClient {
  ...
  final _KEYWORDS = "keywords";

  Client _client = new Client();
  static final AlphaVantageClient _alphaVantageClient =
      new AlphaVantageClient.internal();
  ...
  Map<String, String> _addQueryParams(
    ...
    _updateQueryMap(queryParams, this._KEYWORDS, keywords);
    return queryParams;
  }
